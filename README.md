# Voice Cloning Projekt & AutoGPT

Dieses Projekt enthält eine Web-Anwendung zum Klonen von Stimmen und integriert die AutoGPT-Plattform.

## Struktur

- `/frontend`: Enthält die React-Benutzeroberfläche.
- `/backend`: Enthält den FastAPI-Server.
- `/Auto-GPT`: Enthält die AutoGPT-Plattform und Agenten.
...
>>>>>>> 70fadb902d0b4bbcce131af8c9ee12bff8ceb7d7
